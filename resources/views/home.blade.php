...
<div class="container">
    <div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">Search for a City</div>
            <div id="locationField">
                <input id="autocomplete" placeholder="Enter a city" onFocus="geolocate()" type="text"></input>
            </div>
            <div id="content"></div>
            <div id="map"></div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                Click <a href="{{ url('/places/checklist') }}">here</a> to view your checklist.
            </div>
        </div>
    </div>
